...
#ifndef GLTFIO_MESHPIPELINE_H
#define GLTFIO_MESHPIPELINE_H
...
/**
 * MeshPipeline offers access to glTF processing facilities, independent of the Filament renderer.
 *
 * This is the place for things like atlasing, baking, and optimization of glTF scenes.
 *
 * One instance of MeshPipeline is a context object that makes it simple to manage memory for all
 ...
 * MeshPipeline::AssetHandle asset = pipeline.load("source.gltf");
...
public:
    ...
    MeshPipeline(MeshPipeline const&) = delete;
    MeshPipeline(MeshPipeline&&) = delete;
    MeshPipeline& operator=(MeshPipeline const&) = delete;
